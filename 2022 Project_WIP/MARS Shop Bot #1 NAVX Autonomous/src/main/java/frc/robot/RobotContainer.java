...
public class RobotContainer {
  ...
  private final NavXGyroscope navXGyroscope = new NavXGyroscope();
  ...
  private final JoystickButton navXHeaderResetButton = new JoystickButton(leftJoystick, Constants.navXHeaderResetButtonNumber);
  ...
  private final AutonomousDriveForward autonomousDriveForward = new AutonomousDriveForward(navXHeaderResetButton, navXGyroscope);
  ...
  public RobotContainer() {
    ...
    navXGyroscope.setDefaultCommand(autonomousDriveForward);
